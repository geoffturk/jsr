    ...
    let test_schema = {
      ...
      properties: {
        linked_schemas: {
          ...
          metadata: {
            ...
            context: [
              "https://murmurations.network/fields/linked_schemas"
            ]
          }
        },
        name: {
        ...
        location: {
          ...
          properties: {
            country: {
              ...
              description: "The two-letter country code according to the ISO 3166-1 standard",
              type: "string",
              enum: [
                "AF",
                "AX",
        ...
        rss: {
          title: "RSS feed",
          description: "The URL for this entities RSS feed - usually somemthing like: yoursite.com/rss",
          type: "string",
          maxLength: 100,
          pattern: "https?://",
          metadata: {
        ...
        org_type_tags: {
          ...
          description: "What type of Organisation is this? e.g. Private limited company, School, Co-op, etc.",
          type: "array",
          items: {
            type: "string",
            minLength: 1,
      ...
      metadata: {
        ...
        schema: {
          ...
          version: 1,
          purpose: "A map of organisations within the regenerative economy that have created Murmurations profiles.",
